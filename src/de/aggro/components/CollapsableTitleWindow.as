package de.aggro.components
{
	...
	{	
		...
		protected var collapseButton:Sprite;			
     	...
     	private var _WasMaximized:Boolean;
...
//        	        	
//            closeButton.x = unscaledWidth - x - bm.right ; //-10 // -15 wes
...
//        	resizeButton.y = unscaledHeight - resizeButton.height + 1;
			...
			//figure out x offset                         
            var borderThicknessLeft:int = int(this.getStyle("borderThicknessLeft"));
            var borderThicknessRight:int = int(this.getStyle("borderThicknessRight"));            
            var xOffset:int = (borderThicknessLeft + borderThicknessRight) - 10;
            
            closeButton.x = unscaledWidth - x - bm.right + xOffset - 15;
            closeButton.y = (headerHeight - 15) / 2;
            ...
            resizeButton.x = unscaledWidth - x - bm.right + xOffset;
            resizeButton.y = unscaledHeight - resizeButton.height + 1;
